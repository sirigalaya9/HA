...
export default class Lookup extends LightningElement {
    ...
    handleKeyDown(event) {
        ...
        else if (event.keyCode === ENTER && this._focusedResultIndex == -1) {
            event.preventDefault();
        }
    }
    ...
    handleBlur() {
        ...
        if (this._cancelBlur) {
            console.log('this.isSelectionAllowed():' + this.isSelectionAllowed());
            console.log('this._cancelBlur:' + this._cancelBlur);
            console.log('no');
            return;
        }
        console.log('yes');
